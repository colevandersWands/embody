...
const FALSY_VALUES = [false, 0, -0, 0n, '', null, undefined, Number.NaN] as const;
const TRUTHY_VALUES = [true, 1, 'hello', [], {}, () => {}, Symbol('test'), 42n] as const;
...
describe('represent-coercion', () => {
  describe('test data validation', () => {
    ...
    describe('truthy values', () => {
      it.each([[true], [1], ['hello'], [[]], [{}], [() => {}], [Symbol('test')], [42n]])(
        '%p is truthy',
        (value) => {
  ...
  describe('bitwise operators (|, &, ^, <<, >>, >>>)', () => {
    it.each(['|', '&', '^', '<<', '>>', '>>>'])('%s coerces to number', (op) => {
  ...
  describe('ternary and higher arity operators', () => {
    ...
    it('returns all operands for any arity', () => {
      ...
      expect(result).toEqual([
        { type: 'number', value: 1, lookup: ['Number', 'Object', 'null'], instance: null },
        { type: 'number', value: 2, lookup: ['Number', 'Object', 'null'], instance: null },
        { type: 'number', value: 3, lookup: ['Number', 'Object', 'null'], instance: null },
        { type: 'number', value: 4, lookup: ['Number', 'Object', 'null'], instance: null },
        { type: 'number', value: 5, lookup: ['Number', 'Object', 'null'], instance: null },
      ]);
    });
  });

...
import type { InstrumentInput, InstrumentOutput } from '../types/api';
 ...
 * @since 1.0.0
 */
export default function instrument({ code = '', config = createConfig({}) as ExpandedConfig }: InstrumentInput): InstrumentOutput {
